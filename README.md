...
| ---------------------------- | --------------------------------------------------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--detector_model`           | [SSD MobileNet V2](https://github.com/NikolasChorianopoulos/face-recognision-on-the-google-coral-dev-board/blob/main/models/ssd_mobilenet_v2_face_quant_postprocess_edgetpu.tflite) | Path to the face detector model.                                                                                                                                            |
| `--embedder_model`           |[MobileFaceNet](https://github.com/NikolasChorianopoulos/face-recognision-on-the-google-coral-dev-board/blob/main/models/mobilefacenet_edgetpu.tflite) | Path to the face embedder model.                                                                                                                                            |
