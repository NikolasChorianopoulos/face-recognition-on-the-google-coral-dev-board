...
| ---------------------------- | --------------------------------------------------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--detector_model`           | `models/ssd_mobilenet_v2_face_quant_postprocess_edgetpu.tflite` | Path to the face detector model.                                                                                                                                            |
| `--embedder_model`           |                           `models/mobilefacenet_edgetpu.tflite` | Path to the face embedder model.                                                                                                                                            |
